...
class AvoidRespawnStrategy extends BaseStrategy {
    ...
    accepts (creep) {
        ...
        let nonDisabled = creep.pos.findInRange(FIND_HOSTILE_CREEPS, 3, {filter:(c)=>(c.pos.getRangeTo(creep) <= this.minrange) || (c.getActiveBodyparts(ATTACK) + c.getActiveBodyparts(RANGED_ATTACK)>1)});
