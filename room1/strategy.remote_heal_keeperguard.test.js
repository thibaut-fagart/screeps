...
global.StructureTower = require('../ScreepsAutocomplete/Structures/StructureTower');
let Creep = require('../ScreepsAutocomplete/Creep');
// it('RCL1', function () {
var HealStrategy = require('./strategy.remote_heal_keeperguard'), strategy = new HealStrategy(5);
...
Creep.getActiveBodyparts = function(part) {switch (part) {
    default: return 1;
} };
RoomPosition.findInRange 
let creep = Object.create(Creep);
